...
getethip_target=getethip
getethip_sources=getethip.c
getethip_cc=$(HOSTCC)
getethip_ld=$(HOSTLD)
getethip_cflags=$(CFLAGS)
getethip_ldflags=$(LDFLAGS)
mcastethip_target=mcastethip
mcastethip_sources=mcastethip.c
mcastethip_cc=$(CC)
mcastethip_ld=$(LD)
mcastethip_cflags=$(CFLAGS)
mcastethip_ldflags=$(LDFLAGS)
build_targets=mcastserver mcastcli
build_targets+=mcastserver2 mcastcli2
build_targets+=getethip
build_targets+=mcastethip
